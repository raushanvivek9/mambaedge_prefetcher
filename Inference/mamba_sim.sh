...
#SBATCH --mem=32G
#SBATCH --time=6:00:00
#SBATCH --output=logs/mambaedge_sim_%j.out
#SBATCH --error=logs/mambaedge_sim_%j.err
...
SCRIPT="${WORK_DIR}/champsim_simulate.py"
OUT_JSON="${WORK_DIR}/mambaedge_sim_results_champ.json"
# ═══════════════════════════════════════════════════════════════
